...
if data.raw.recipe["omni-pack"] then
	table.insert(results_1, {type="item", name="omni-pack", amount=amount_param, independent_probability=0.4})
end
if mods["angelsindustries"] and settings.startup["angels-enable-tech"].value then
  table.insert(results_1, {type="item", name="angels-science-pack-grey", amount=amount_param, independent_probability=0.04})
else
  table.insert(results_1, {type="item", name="automation-science-pack", amount=amount_param, independent_probability=0.4})
  table.insert(results_1, {type="item", name="logistic-science-pack", amount=amount_param, independent_probability=0.4})
  table.insert(results_1, {type="item", name="chemical-science-pack", amount=amount_param, independent_probability=0.4})
end

local results_2 = {}

if data.raw.recipe["omni-pack"] then
	table.insert(results_2, {type="item", name="omni-pack", amount=amount_param, independent_probability=0.3})
end
if mods["angelsindustries"] and settings.startup["angels-enable-tech"].value then
  table.insert(results_2, {type="item", name="angels-science-pack-red", amount=amount_param, independent_probability=0.03})
  table.insert(results_2, {type="item", name="angels-science-pack-green", amount=amount_param, independent_probability=0.03})
  table.insert(results_2, {type="item", name="angels-science-pack-orange", amount=amount_param, independent_probability=0.03})
else
  table.insert(results_2, {type="item", name="automation-science-pack", amount=amount_param, independent_probability=0.3})
  table.insert(results_2, {type="item", name="logistic-science-pack", amount=amount_param, independent_probability=0.3})
  table.insert(results_2, {type="item", name="chemical-science-pack", amount=amount_param, independent_probability=0.3})
  table.insert(results_2, {type="item", name="military-science-pack", amount=amount_param, independent_probability=0.3})
  table.insert(results_2, {type="item", name="production-science-pack", amount=amount_param, independent_probability=0.3})
end
local results_3 = {}

if data.raw.recipe["omni-pack"] then
	table.insert(results_3, {type="item", name="omni-pack", amount=amount_param, independent_probability=0.2})
end
if mods["angelsindustries"] and settings.startup["angels-enable-tech"].value then
  table.insert(results_3, {type="item", name="angels-science-pack-blue", amount=amount_param, independent_probability=0.02})
  table.insert(results_3, {type="item", name="angels-science-pack-yellow", amount=amount_param, independent_probability=0.02})
else
  table.insert(results_3, {type="item", name="automation-science-pack", amount=amount_param, independent_probability=0.2})
  table.insert(results_3, {type="item", name="logistic-science-pack", amount=amount_param, independent_probability=0.2})
  table.insert(results_3, {type="item", name="chemical-science-pack", amount=amount_param, independent_probability=0.2})
  table.insert(results_3, {type="item", name="military-science-pack", amount=amount_param, independent_probability=0.2})
  table.insert(results_3, {type="item", name="production-science-pack", amount=amount_param, independent_probability=0.2})
  if data.raw.recipe["bob-advanced-logistic-science-pack"] then
    table.insert(results_3, {type="item", name="bob-advanced-logistic-science-pack", amount=amount_param, independent_probability=0.2})
  end
  table.insert(results_3, {type="item", name="utility-science-pack", amount=amount_param, independent_probability=0.2})
end
...
if data.raw.recipe["omni-pack"] then
	table.insert(results_4, {type="item", name="omni-pack", amount=amount_param, independent_probability=0.1})
end

if mods["angelsindustries"] and settings.startup["angels-enable-tech"].value then
  table.insert(results_4, {type="item", name="angels-science-pack-white", amount=amount_param, independent_probability=0.01})
else
  table.insert(results_4, {type="item", name="automation-science-pack", amount=amount_param, independent_probability=0.1})
  table.insert(results_4, {type="item", name="logistic-science-pack", amount=amount_param, independent_probability=0.1})
  table.insert(results_4, {type="item", name="chemical-science-pack", amount=amount_param, independent_probability=0.1})
  table.insert(results_4, {type="item", name="military-science-pack", amount=amount_param, independent_probability=0.1})
  table.insert(results_4, {type="item", name="production-science-pack", amount=amount_param, independent_probability=0.1})
  if data.raw.recipe["bob-advanced-logistic-science-pack"] then
    table.insert(results_4, {type="item", name="bob-advanced-logistic-science-pack", amount=amount_param, independent_probability=0.1})
  end
  table.insert(results_4, {type="item", name="utility-science-pack", amount=amount_param, independent_probability=0.1})
  table.insert(results_4, {type="item", name="space-science-pack", amount=amount_param, independent_probability=0.1})
end
