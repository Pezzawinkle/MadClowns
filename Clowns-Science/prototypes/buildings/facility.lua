...
--	flags = {"goes-to-quickbar"},
...

	{
		...
		minable = {hardness = 0.8, mining_time = 1.2, result = "facility-mk1"},
		max_health = 500,
...

	{
		...
		icon_size = 32,
		flags = {"placeable-neutral", "placeable-player", "player-creation"},
		minable = {hardness = 0.8, mining_time = 1.2, result = "facility-mk2"},
		max_health = 500,
		corpse = "medium-remnants",
		dying_explosion = "medium-explosion",
		light = {intensity = 1, size = 100},--int = 0.75, s = 8
...

	{
		...
		icon_size = 32,
		flags = {"placeable-neutral", "placeable-player", "player-creation"},
		minable = {hardness = 0.8, mining_time = 1.2, result = "facility-mk3"},
		max_health = 500,
		corpse = "medium-remnants",
		dying_explosion = "medium-explosion",
		light = {intensity = 1, size = 100},--int = 0.75, s = 8
