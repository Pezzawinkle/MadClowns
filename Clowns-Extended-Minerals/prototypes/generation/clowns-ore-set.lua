...
local ore_dat={
	["clowns-ore1"]={
		...
		ore_sheet=3,
		order="c-a",
		mining_time = 3*4, --old time * hardness
		tint = {r = 0.6510, g = 0.3490, b = 0.6510},
	},
	["clowns-ore2"]={
		--stage="clowns_ore2",
		ore_sheet=4,
		order="c-b",
		mining_time = 1.75*2.75, --old time * hardness
		tint = {r = 1, g = 0, b = 0.5},
	},
	["clowns-ore3"]={
		--stage="clowns_ore3",
		ore_sheet=3,
		order="c-c",
		mining_time = 1.5*0.9, --old time * hardness
	...
	["clowns-ore4"]={
		...
		ore_sheet=1,
		order="c-d",
		mining_time = 2*1.5, --old time * hardness
		tint = {r = 1, g = 0.3438, b = 0.0},
	},
	["clowns-ore5"]={
		--stage="clowns_ore5",
		ore_sheet=3,
	...
	["clowns-ore6"]={
		...
		ore_sheet=2,
		order="c-f",
		mining_time = 1.75*2, --old time * hardness
		tint = {r = 0.9020, g = 0.0000, b = 0.0000},
	},
	["clowns-ore7"]={
		--stage="clowns_ore7",
		ore_sheet=2,
		order="c-g",
		mining_time = 2*3, --old time * hardness
		tint = {r = 0.48, g = 0.63, b = 0.15},
	},
	--resource8,9 not to spawn, skipping those
}
...
inf_dat={
["infinite-clowns-ore1"]=ore_dat["clowns-ore1"],
["infinite-clowns-ore2"]=ore_dat["clowns-ore2"],
["infinite-clowns-ore3"]=ore_dat["clowns-ore3"],
["infinite-clowns-ore4"]=ore_dat["clowns-ore4"],
["infinite-clowns-ore5"]=ore_dat["clowns-ore5"],
["infinite-clowns-ore6"]=ore_dat["clowns-ore6"],
["infinite-clowns-ore7"]=ore_dat["clowns-ore7"],
}
