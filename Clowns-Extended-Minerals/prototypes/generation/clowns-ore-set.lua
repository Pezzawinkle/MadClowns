...
if not special_vanilla then
  ...
  ore_dat["clowns-ore8"] = {--[[stage="clowns_ore8",]]ore_sheet = 2,	order = "c-h",	mining_time = 1.4*4--[[old time * hardness]], tint = {r = 110, g = 207, b = 148}}
  ore_dat["clowns-ore9"] = {--[[stage="clowns_ore9",]]ore_sheet = 2,	order = "c-i",	mining_time = 1.6*4--[[old time * hardness]], tint = {r = 219, g = 160, b = 0.0000}}
