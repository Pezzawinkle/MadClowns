if mods["angelsinfiniteores"] and settings.startup["enableinfiniteclownsresource2"].value == true then
	local name = "infinite-clowns-resource2"
	local stage = "infinite-clowns_resource2"
	...
	local name_of_original_ore = "clowns-resource2" --=name unless it's an infinite ore
