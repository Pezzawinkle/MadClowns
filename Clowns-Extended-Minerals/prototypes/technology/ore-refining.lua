...
if not clowns.special_vanilla then --add in the mixed sorting recipes to the techs
  table.insert(data.raw.technology["clowns-advanced-ore-refininhg"].effects,{type = "unlock-recipe",recipe = "angels-manganese-pure-processing"})
  table.insert(data.raw.technology["clowns-advanced-ore-refininhg"].effects,{type = "unlock-recipe",recipe = "clowns-phosphorus-pure-processing"})
  ...
  table.insert(data.raw.technology["clowns-ore-refining"].effects,{type = "unlock-recipe",recipe = "clowns-platinum-pure-processing"})
...
if not clowns.special_vanilla then
  for i=11,15,1 do
    ...
    table.insert(data.raw.technology["clowns-ore-electro-whinning-cell"].effects,{type = "unlock-recipe",recipe = "clownsore"..i.."-solution"})
    table.insert(data.raw.technology["clowns-ore-electro-whinning-cell"].effects,{type = "unlock-recipe",recipe = "clownsore"..i.."-anode-sludge-filtering"})
    table.insert(data.raw.technology["clowns-ore-electro-whinning-cell"].effects,{type = "unlock-recipe",recipe = "clownsore"..i.."-anode-sludge"})
    table.insert(data.raw.technology["clowns-ore-electro-whinning-cell"].effects,{type = "unlock-recipe",recipe = "clownsore"..i.."-crystal"})
    table.insert(data.raw.technology["clowns-ore-electro-whinning-cell"].effects,{type = "unlock-recipe",recipe = "clownsore"..i.."-crystal-processing"})
  end
